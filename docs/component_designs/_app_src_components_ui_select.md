# Detalle de Diseño y Textos: /app/src/components/ui/select.tsx
...
- `{cn("px-1.5 py-1 text-xs text-muted-foreground", className)}`
- `{cn(
...
- `pointer-events-none`
- `{cn("pointer-events-none -mx-1 my-1 h-px bg-border", className)}`
- `{cn(
...
- **<SelectPrimitive.Viewport>**: {children}
