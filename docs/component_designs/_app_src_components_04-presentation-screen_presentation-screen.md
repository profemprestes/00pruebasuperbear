...
- `absolute inset-0 bg-gradient-to-b from-black/50 via-black/40 to-black/60 z-0`
- `absolute inset-0 pointer-events-none z-0`
- `absolute w-2 h-2 bg-golden-coin rounded-full opacity-60`
- `relative bg-white/95 backdrop-blur-sm border-[6px] sm:border-8 border-[hsl(var(--foreground))] rounded-2xl sm:rounded-3xl shadow-[8px_8px_0px_hsl(var(--foreground))] overflow-hidden`
- `absolute top-0 left-0 right-0 h-2 sm:h-3 bg-gradient-to-r from-grass-green via-golden-coin to-grass-green`
- `flex flex-col md:flex-row items-center gap-4 sm:gap-6 md:gap-8 p-6 sm:p-8 md:p-10 pt-12 sm:pt-14 md:pt-12`
- `flex-shrink-0 relative w-full md:w-auto flex justify-center md:justify-start`
- `absolute inset-0 flex items-center justify-center`
- `w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-72 lg:h-72 rounded-full border-4 border-dashed border-golden-coin/30`
- `w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full bg-golden-coin/20 blur-xl`
- `relative z-10`
- `w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 drop-shadow-[6px_6px_0px_rgba(0,0,0,0.3)] transition-transform duration-300 hover:scale-125 hover:rotate-6 cursor-pointer`
- `absolute -bottom-2 -right-2 sm:-bottom-3 sm:-right-3 bg-golden-coin border-3 border-[hsl(var(--foreground))] rounded-full px-2 py-1 sm:px-3 sm:py-1 shadow-[3px_3px_0px_hsl(var(--foreground))]`
- `font-impact text-xs sm:text-sm text-[hsl(var(--foreground))]`
- `flex-1 text-center md:text-left space-y-4 sm:space-y-5`
- `leading-tight`
- `inline-block`
- `inline-block text-transparent bg-clip-text bg-gradient-to-r from-grass-green via-golden-coin to-grass-green`
- `w-20 sm:w-24 h-1 bg-gradient-to-r from-grass-green to-golden-coin mx-auto md:mx-0 rounded-full`
- `font-body text-sm sm:text-base md:text-lg text-[#333] leading-relaxed break-words`
- `flex flex-wrap gap-3 justify-center md:justify-start pt-2`
- `voxel-card px-3 py-2 bg-grass-green/10`
- `voxel-card px-3 py-2 bg-golden-coin/10`
- `voxel-card px-3 py-2 bg-sky-blue/20`
- `relative bg-gradient-to-r from-sky-light/50 via-white to-sky-light/50 border-t-4 border-[hsl(var(--foreground))] p-4 sm:p-6`
- `flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4`
- `flex items-center gap-2`
- `w-3 h-3 rounded-full bg-grass-green animate-pulse`
- `font-amble text-xs sm:text-sm text-[hsl(var(--foreground))]`
- `relative overflow-hidden group font-milky`
- `absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent`
- `text-center mt-4 sm:mt-6`
