# Detalle de Diseño y Textos: /app/src/components/05-register-screen/register-screen.tsx
...
- **<div>**: {/* Overlay de profundidad */} {/* Partículas de "Polvo de Estrellas/Pintura" */} {/* Contenedor principal responsive */}
...
- **<Container>**: {/* SHICKA - SIEMPRE VISIBLE ARRIBA (mobile first) */} {/* Layout Desktop: Shicka izquierda, Tarjeta derecha */} {/* TARJETA DE REGISTRO - Mobile (debajo de Shicka) */} {/* Footer decorativo */}
- **<div>**: {/* Globo de texto - Posición fija y visible */} {/* Personaje Shicka */}
- **<motion.div>**: {/* Puntero del globo */}
- **<p>**: {shickaPhrase}
- **<motion.div>**: {/* Aura */} {/* Etiqueta */}
- **<div>**: ✦ GUÍA ALIADA ✦
- **<div>**: {/* IZQUIERDA: SHICKA */} {/* DERECHA: TARJETA DE REGISTRO */}
- **<div>**: {/* Globo de texto - Posición visible */} {/* Personaje Shicka */}
- **<motion.div>**: {/* Puntero del globo (abajo) */}
- **<p>**: {shickaPhrase}
- **<motion.div>**: {/* Aura */} {/* Etiqueta */}
- **<div>**: ✦ GUÍA ALIADA ✦
- **<motion.div>**: {/* Franja decorativa superior */}
- **<h2>**: {content.title}
