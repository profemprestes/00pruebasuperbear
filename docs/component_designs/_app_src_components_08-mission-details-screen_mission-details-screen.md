...
- `relative z-10 mb-4 sm:mb-6 md:mb-8 pt-4 sm:pt-6`
- `bg-gradient-to-r from-golden-coin via-yellow-300 to-golden-coin border-4 border-teddy-brown px-4 sm:px-6 py-2 sm:py-3 rounded-full shadow-[0_4px_0_#63340b]`
- `font-arcade text-teddy-brown text-xs sm:text-sm md:text-base lg:text-lg tracking-widest whitespace-nowrap`
- `md:hidden flex flex-col items-center gap-4`
- `relative flex flex-col items-center`
- `bg-white border-4 border-sky-blue px-4 py-3 rounded-2xl shadow-xl mb-4 relative w-64`
- `font-body text-xs text-teddy-brown font-semibold text-center leading-tight`
...
- `w-40 h-40 rounded-full bg-golden-coin/30 blur-2xl`
- `relative z-10 drop-shadow-[0_15px_30px_rgba(255,215,0,0.5)]`
- `w-full bg-gradient-to-br from-amber-50 via-yellow-50 to-amber-100 border-6 sm:border-8 border-teddy-brown rounded-3xl p-4 sm:p-6 shadow-[10px_10px_0px_#63340b] relative`
- `absolute top-0 left-0 right-0 h-2 sm:h-3 bg-gradient-to-r from-sky-blue via-grass-green to-sky-blue rounded-t-3xl`
- `font-milky text-xl sm:text-2xl md:text-3xl text-teddy-brown mb-4 sm:mb-6 text-center pt-2`
- `grid grid-cols-1 gap-3 sm:gap-4 font-amble`
- `bg-white/80 p-3 sm:p-4 rounded-xl border-3 border-sky-blue flex items-center gap-3 sm:gap-4 shadow-[3px_3px_0px_rgba(0,0,0,0.1)]`
- `bg-sky-blue/20 p-2 sm:p-3 rounded-lg`
- `text-sky-blue w-5 h-5 sm:w-6 sm:h-6`
- `flex-1`
- `text-[10px] sm:text-xs uppercase text-gray-500 font-semibold`
- `font-bold text-sm sm:text-base text-teddy-brown`
- `text-xs text-gray-600`
- `font-bold text-xs sm:text-sm text-teddy-brown leading-tight`
- `mt-4 sm:mt-6 bg-black/80 p-3 sm:p-4 rounded-2xl border-3 border-golden-coin text-center shadow-[0_6px_0_#63340b]`
...
- `w-5 h-5`
- `w-full font-amble text-sm sm:text-base font-semibold text-white bg-gradient-to-r from-sky-blue to-blue-500 hover:from-sky-400 hover:to-blue-400 border-3 border-white/50 rounded-xl px-4 py-3 transition-all shadow-[0_4px_0_#0056b3] hover:shadow-[0_6px_0_#0056b3] hover:-translate-y-0.5 active:translate-y-0.5 active:shadow-[0_2px_0_#0056b3] flex items-center justify-center gap-2`
- `w-full font-amble text-xs sm:text-sm font-semibold text-sky-blue hover:text-blue-600 hover:underline transition-all py-2`
- `hidden md:flex flex-row items-start gap-12 lg:gap-16`
- `w-1/3 flex flex-col items-center`
- `bg-white border-4 border-sky-blue p-5 rounded-2xl shadow-xl mb-6 relative max-w-xs`
- `font-body text-sm text-teddy-brown font-semibold text-center leading-relaxed`
- `absolute -bottom-4 right-12 w-0 h-0 border-l-[12px] border-l-transparent border-t-[16px] border-t-sky-blue border-r-[12px] border-r-transparent`
- `w-64 h-64 rounded-full bg-golden-coin/30 blur-2xl`
- `absolute -bottom-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-golden-coin to-yellow-500 text-teddy-brown font-arcade text-xs px-4 py-2 rounded-full border-3 border-white shadow-lg whitespace-nowrap`
- `flex-1 bg-gradient-to-br from-amber-50 via-yellow-50 to-amber-100 border-8 border-teddy-brown rounded-3xl p-8 lg:p-10 shadow-[12px_12px_0px_#63340b] relative`
- `absolute top-0 left-0 right-0 h-3 bg-gradient-to-r from-sky-blue via-grass-green to-sky-blue rounded-t-3xl`
- `font-milky text-3xl md:text-4xl text-teddy-brown mb-8 text-center pt-2`
- `grid grid-cols-2 gap-4 lg:gap-6 font-amble`
- `bg-white/80 p-4 lg:p-5 rounded-xl border-3 border-sky-blue flex items-start gap-4 shadow-[3px_3px_0px_rgba(0,0,0,0.1)] hover:shadow-[5px_5px_0px_rgba(0,0,0,0.15)] transition-shadow`
- `bg-sky-blue/20 p-3 rounded-lg`
- `text-sky-blue w-6 h-6`
- `text-[10px] uppercase text-gray-500 font-semibold tracking-wider`
- `font-bold text-base text-teddy-brown`
- `font-bold text-sm text-teddy-brown leading-tight`
- `mt-8 bg-black/80 p-5 rounded-2xl border-3 border-golden-coin text-center shadow-[0_6px_0_#63340b]`
