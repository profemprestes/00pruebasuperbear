...
- `w-40 h-40 sm:w-48 sm:h-48 rounded-2xl flex items-center justify-center text-6xl sm:text-7xl`
- `font-milky text-lg text-teddy-brown`
- `space-y-4`
- `flex gap-3 sm:gap-4 overflow-x-auto snap-x snap-mandatory pb-4`
- `flex-shrink-0 w-[calc(100vw-4rem)] sm:w-64 h-56 sm:h-64 rounded-xl overflow-hidden snap-center`
- `w-full h-full object-cover`
- `flex-shrink-0 w-64 h-64 rounded-xl flex items-center justify-center bg-sky-light`
- `text-6xl`
- `font-amble text-sm text-voxel-text`
