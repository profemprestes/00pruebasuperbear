...
- `absolute inset-0 bg-black/70 backdrop-blur-lg z-0`
- `font-milky text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white mb-6 sm:mb-8`
- `grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 lg:gap-4 mb-8 sm:mb-12 max-w-xs sm:max-w-md lg:max-w-xl mx-auto`
- `bg-white/10 border-2 border-golden-coin rounded-lg sm:rounded-xl shadow-lg flex flex-col items-center justify-center p-2 sm:p-3 lg:p-4 aspect-square transition-transform hover:scale-105 active:scale-95`
- `text-2xl sm:text-3xl lg:text-5xl`
- `font-body text-white font-bold text-[10px] sm:text-xs lg:text-sm mt-1 sm:mt-2 text-center leading-tight`
- `flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-12`
- `group bg-white p-3 sm:p-4 pb-8 sm:pb-10 shadow-lg border-4 border-gray-300 relative sm:-rotate-3 transition-all duration-300 ease-in-out hover:scale-105 sm:hover:rotate-0 hover:z-10 w-full max-w-[220px] sm:max-w-[260px] lg:max-w-[300px]`
- `w-full object-cover aspect-square rounded-sm`
- `absolute bottom-1 sm:bottom-2 left-1/2 -translate-x-1/2 font-milky text-sm sm:text-lg text-teddy-brown whitespace-nowrap`
- `group bg-white p-3 sm:p-4 pb-8 sm:pb-10 shadow-lg border-4 border-gray-300 relative sm:rotate-3 transition-all duration-300 ease-in-out hover:scale-105 sm:hover:rotate-0 hover:z-10 w-full max-w-[220px] sm:max-w-[260px] lg:max-w-[300px]`
- `font-body text-base sm:text-lg lg:text-xl text-white/90 mt-4 sm:mt-8 mb-6 sm:mb-8`
- `relative inline-block`
- `absolute -top-10 sm:-top-12 left-1/2 -translate-x-1/2 text-grass-green motion-safe:animate-bounce flex flex-col items-center pointer-events-none`
- `font-milky text-xs sm:text-sm bg-white/90 px-2 sm:px-3 rounded-full border-2 border-grass-green text-black`
