...
- `absolute inset-0 z-0 md:hidden`
- `absolute inset-0 w-full h-full object-cover z-0 hidden md:block`
- `absolute inset-0 z-0 hidden md:block`
- `absolute inset-0 pointer-events-none md:hidden`
- `{`absolute text-xl sm:text-2xl motion-safe:animate-subtle-float ${pos}`}`
- `absolute top-20 right-4 sm:right-6 text-2xl sm:text-3xl motion-safe:animate-subtle-float`
- `relative z-10 flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-10 md:gap-16 w-full max-w-5xl px-4 sm:px-8 md:px-12`
- `motion-safe:animate-float flex-shrink-0`
- `w-40 h-40 sm:w-56 sm:h-56 md:w-72 md:h-72 lg:w-[450px] lg:h-[450px] drop-shadow-[0_8px_12px_rgba(0,0,0,0.3)] md:drop-shadow-[0_16px_24px_rgba(0,0,0,0.5)]`
- `flex flex-col items-center gap-3 sm:gap-4 md:gap-6 w-full max-w-xs sm:max-w-md md:max-w-2xl`
- `w-64 sm:w-80 md:w-[32rem] lg:w-[45rem] drop-shadow-lg md:drop-shadow-[0_8px_20px_rgba(255,215,0,0.6)] hover:scale-105 transition-transform duration-300`
- `w-full`
- `h-6 sm:h-8 md:h-10 rounded-full border-4 sm:border-[5px] md:border-[6px] border-teddy-brown overflow-hidden relative`
- `h-full rounded-full transition-all duration-75`
- `font-impact sm:font-arcade text-teddy-brown sm:text-golden-coin tracking-widest text-xs sm:text-sm md:text-xl text-center mt-1 sm:mt-2 drop-shadow-[0_1px_2px_rgba(0,0,0,0.4)] sm:drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]`
- `hidden md:flex gap-4 text-2xl lg:text-3xl`
- `motion-safe:animate-bounce-light`
