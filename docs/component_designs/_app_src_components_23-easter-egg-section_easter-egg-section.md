...
- `text-center`
- `text-4xl sm:text-5xl lg:text-6xl block mb-2`
- `font-milky text-xs text-teddy-brown`
- `mt-4 font-amble text-xs text-voxel-text`
...
- `font-milky text-2xl sm:text-3xl text-white tracking-wider`
- `font-amble text-sm text-white/90 text-center max-w-xs`
- `flex flex-col gap-3`
- `font-milky text-lg h-auto py-3 px-6 text-white`
- `font-arcade text-xs text-black/60 text-center`
