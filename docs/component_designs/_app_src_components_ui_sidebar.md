# Detalle de Diseño y Textos: /app/src/components/ui/sidebar.tsx
...
- `{cn("h-8 w-full bg-background shadow-none", className)}`
- `{cn("flex flex-col gap-2 p-2", className)}`
- `{cn("mx-2 w-auto bg-sidebar-border", className)}`
- `{cn(
...
- `size-4 rounded-md`
- `h-4 max-w-[var(--skeleton-width)] flex-1`
- `{cn(
...
- **<div>**: {children}
- **<div>**: {/* This is what handles the sidebar gap on desktop */}
- **<div>**: {children}
- **<span>**: Toggle Sidebar
- **<TooltipTrigger>**: {button}
- **<div>**: {showIcon && ( <Skeleton className="size-4 rounded-md" data-sidebar="menu-skeleton-icon" /> )}
