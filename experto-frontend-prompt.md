# Prompt para Analizar y Pulir Repositorios Frontend (Experto UX/UI y Frontend)

Si deseas abrir una nueva conversación con un modelo de IA para que analice un repositorio completo desde cero y aplique una capa de "pulido global" (responsividad, feedback de botones, game feel o animaciones), puedes copiar y pegar el siguiente prompt en el nuevo chat:
