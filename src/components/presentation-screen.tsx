...
export function PresentationScreen({ onNext, facuBio }: PresentationScreenProps) {
  return (
    ...
    >
      ...
      <div className="relative bg-white border-8 border-[hsl(var(--foreground))] rounded-2xl p-6 sm:p-8 pt-20 sm:pt-12 shadow-[8px_8px_0px_hsl(var(--foreground))] max-w-2xl w-[95%] sm:w-full m-4 motion-safe:animate-in fade-in-0 zoom-in-95 slide-in-from-bottom-8 duration-500">
        <div className="absolute -top-16 left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:-top-20 sm:-left-12 z-10">
          <Image
            ...
            width={150}
            height={150}
            className="drop-shadow-[4px_4px_0px_rgba(0,0,0,0.3)] w-[120px] sm:w-[150px] transition-transform duration-300 hover:scale-110 motion-safe:animate-float"
          />
        </div>
        ...
        <div className="text-center sm:text-left sm:ml-0 md:ml-32 relative">
            ...
            <p className="font-body text-md sm:text-lg text-[#333] mt-4 leading-relaxed break-words whitespace-normal">
