...
export function PresentationScreen({ onNext }: PresentationScreenProps) {
  return (
    ...
    >
      ...
      <div className="relative bg-white border-8 border-[hsl(var(--foreground))] rounded-2xl p-6 sm:p-8 pt-20 sm:pt-12 shadow-[8px_8px_0px_hsl(var(--foreground))] max-w-2xl w-[95%] sm:w-full m-4">
        ...
        <button
          onClick={onNext}
          className="absolute -bottom-5 right-4 font-milky text-white text-lg sm:text-xl px-6 py-3 rounded-lg bg-grass-green border-0 shadow-[0_6px_0_#2E8B57] transition-all duration-150 hover:bg-green-500 hover:shadow-[0_4px_0_#2E8B57] active:translate-y-[6px] active:shadow-none"
        >
          Ver Misión ➔
        </button>
      </div>
