...
export function PresentationScreen({ onNext }: PresentationScreenProps) {
  return (
    ...
    >
      ...
      <div className="relative bg-white border-8 border-[hsl(var(--foreground))] rounded-2xl p-8 pt-16 sm:pt-12 shadow-[8px_8px_0px_hsl(var(--foreground))] max-w-2xl w-full m-4">
        ...
        <div className="text-center sm:text-left sm:ml-32 relative">
            <h2 className="font-milky text-4xl md:text-5xl text-[hsl(var(--foreground))]">
                ¡Nivel 9 Desbloqueado!
            </h2>
            <p className="font-body text-lg sm:text-xl md:text-2xl text-[#333] mt-4">
        ...
        <button
          onClick={onNext}
          className="absolute -bottom-5 right-4 font-milky text-white text-lg sm:text-xl px-6 py-3 rounded-lg bg-[#7CFC00] border-0 shadow-[0_6px_0_#2E8B57] transition-all duration-150 active:translate-y-[6px] active:shadow-none"
        >
          Ver Misión ➔
        </button>
      </div>
