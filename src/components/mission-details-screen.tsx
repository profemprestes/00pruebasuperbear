...
export function MissionDetailsScreen({ playerName, onNext, playedMinigames, avatarConfig }: MissionDetailsScreenProps) {
  ...
  if (playedMinigames) {
    return ( // VIP Version
      ...
      >
          ...
          <div className="relative z-10 bg-gradient-to-br from-yellow-50 to-amber-100 border-[8px] border-golden-coin rounded-2xl shadow-[0_10px_30px_rgba(255,215,0,0.5),_8px_8px_0px_#b8860b] w-[95%] max-w-2xl p-6 sm:p-8 space-y-4 text-center motion-safe:animate-in fade-in-0 zoom-in-95 slide-in-from-bottom-8 duration-500">
                ...
                <div className="relative w-full md:w-auto">
                    <Button
                        ...
                        className={`font-milky text-xl sm:text-2xl h-auto py-3 px-6 sm:px-8 border-2 border-teddy-brown transition-all duration-300 w-full md:w-auto mt-8 sm:mt-4 ${
                            ...
                            : 'bg-golden-coin text-white shadow-[0_6px_0_#b8860b] hover:shadow-[0_8px_0_#b8860b] hover:-translate-y-0.5 hover:bg-amber-400 active:translate-y-1 active:shadow-none'
                        }`}
                    >
  ...
  return ( // Standard Version
    ...
    >
        ...
        <div className="relative z-10 bg-amber-50 border-[6px] border-teddy-brown rounded-xl shadow-[8px_8px_0px_#63340b] w-[95%] max-w-2xl p-6 sm:p-8 space-y-4 text-center motion-safe:animate-in fade-in-0 zoom-in-95 slide-in-from-bottom-8 duration-500">
